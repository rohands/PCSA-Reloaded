...
public class FragmentDrawer extends Fragment {
    ...
    private static int[] iconIDs = {R.drawable.ic_home_black_36dp,R.drawable.ic_help_black,R.drawable.ic_circle,R.drawable.ic_phone_black_36dp,R.mipmap.ic_hospital,R.drawable.ic_helpinghands};
